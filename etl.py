...
def process_song_file(cur, filepath):
    """
    insert data into the songs and artists dimensional tables
    """
    # open song file
...
def process_log_file(cur, filepath):
    """
    insert data into the time and users dimensional tables, as well as the songplays fact table
    """
    # open log file
...
def process_data(cur, conn, filepath, func):
    """
    create the fact and dimensional tables
    """
